...
from .data import iCIFAR10, iCIFAR100, iImageNet100, iImageNet1000, Imagenet_R
...
class DataManager(object):
    ...
    def _setup_data(self, dataset_name, shuffle, seed):
        ...
        # Order
        # print('train_targets', len(np.unique(self._train_targets)))
        # print('train_targets', self._train_targets.shape)
